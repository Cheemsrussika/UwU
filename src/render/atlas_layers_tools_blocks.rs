use super::texture_loader::load_atlas_layer;
...
pub fn append_tools_and_blocks(pixels: &mut Vec<u8>) {
    ...
    // 56..=59: WoodenAxe, StoneAxe, IronAxe, DiamondAxe
    ...
    // 60..=63: WoodenShovel, StoneShovel, IronShovel, DiamondShovel
    ...
    // 64..=67: WoodenHoe, StoneHoe, IronHoe, DiamondHoe
    ...
    // 69..=71: IronBlock, CoalBlock, DiamondBlock
