...
use crate::render::hud_ui::lan_screen::get_lan_static_buttons;
use crate::render::hud_ui::menu_button::MenuButton;
use super::super::render::hud_ui::pause_screen::get_pause_buttons;
use super::super::render::hud_ui::title_screen::get_title_buttons;
...
pub fn handle_menu_click(
    ...
    match state {
        ...
        GameState::DirectConnect => {
            for btn in crate::render::hud_ui::direct_connect_screen::get_direct_connect_buttons(aspect) {
                if btn.is_hovered(mouse) {
                    return match btn.id {
